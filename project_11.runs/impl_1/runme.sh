...
HD_PWD='D:/Downloads/Lab10/project_11/project_11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nano.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Nano.tcl -notrace
